...
//audio play:
sel('.music').addEventListener('click', function () {
	id('my_audio').play();
});
//audio pause:
sel('.music').addEventListener('dblclick', function () {
	id('my_audio').pause();
});
//action button Bold:
...
sel('.underline').addEventListener('click', function () {
			...
			//вирівнювання тексту left, center, right:
			...
			//Cтворення та додавання в основний контент table: 
			...
			//Cтворення та додавання в основний контент list:
			//OL list:
			...
			//Функціонал таблиці з кольорами:
